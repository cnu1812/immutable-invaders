...
type TextMessages = Array<ReactNode>;
...
declare function TableCell<RC extends ReactElement | undefined = undefined>({ parentNode, ...props }: TableCellProps<RC>): _emotion_react_jsx_runtime.JSX.Element;
...
declare function TablePageSize({ children, defaultLabel, className, ...props }: TablePageSizeProps): _emotion_react_jsx_runtime.JSX.Element;
declare namespace TablePageSize {
    var displayName: string;
    var DefaultIcon: typeof SelectDefaultIcon;
}

declare function TablePagination<RC extends ReactElement | undefined = undefined>({ sx, className, ...props }: DistributiveOmit<PaginationProps<RC>, 'size'>): _emotion_react_jsx_runtime.JSX.Element;
...
declare function Table<RC extends ReactElement | undefined = undefined>({ children, verticalSpacing, horizontalSpacing, rowHoverFx, stripedBg, tableBorder, rowBorder, columnBorder, stickyHeaders, testId, sx, className, ...props }: RC extends undefined ? DomPropsWithDomRef<'div'> & TableProps : TableProps & {
    rc: RC;
}): _emotion_react_jsx_runtime.JSX.Element;

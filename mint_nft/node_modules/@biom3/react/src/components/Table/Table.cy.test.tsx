...
describe('<Table />', () => {
  it('should forward domRef for root element', () => {
  ...
  context('Sticky headers', () => {
    it('should hard code the width of each table cell, when sticky headers are enabled', () => {
      cyMountWithProviders(
        <Table testId="moo">
          <Table.Head>
            <Table.Row>
          ...
          <Table.Row>
            <Table.Cell testId="cell1">something</Table.Cell>
            <Table.Cell testId="cell2">else</Table.Cell>
            <Table.Cell testId="cell3">entirely</Table.Cell>
          </Table.Row>
        </Table>,
      );

      cySmartGet('cell1--td').should(
        'have.attr',
        'data-has-hardcoded-widths',
        'true',
      );
      cySmartGet('cell2--td').should(
        'have.attr',
        'data-has-hardcoded-widths',
        'true',
      );
      cySmartGet('cell3--td').should(
        'have.attr',
        'data-has-hardcoded-widths',
        'true',
      );
    ...
    it('should NOT hard code the width of each table cell, when sticky headers are disabled', () => {
      cyMountWithProviders(
